...
public class BaseUser : BaseEntity
{
    ...
    protected BaseUser(string firstName, string lastName, string userName, string passwordHash)
    {
    ...
    protected void Update(string firstName, string lastName, string userName, long modifiedBy)
    {
        ValidateName(firstName, lastName);
        ValidateUserName(userName);
        FirstName = firstName;
    ...
    protected void ChangePassword(string passwordHash, long modifiedBy)
    {
        ValidatePasswordHash(passwordHash);
        PasswordHash = passwordHash;
        Modified(modifiedBy);
